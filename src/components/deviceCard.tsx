                        ...
                        <Block title={name} icon={type  === 'output' ? <LaptopIcon /> : <ExclamationTriangleIcon />} >
                            <div>
                                <Toolbar.Root className="flex w-full min-w-max rounded-md bg-neutral-800 p-2.5 max-w-full drop-shadow-lg">
                                    ...
                                    <Toolbar.Button className="bg-neutral-400 hover:bg-indigo-300 ml-0.5 inline-flex h-[25px] flex-shrink-0 flex-grow-0 basis-auto items-center justify-center rounded px-[5px] text-[13px] leading-none outline-none first:ml-0 data-[state=on]:bg-red-500 data-[state=on]:text-green-500 [&>*]:w-[20px] [&>*]:h-[20px]"><OpenInNewWindowIcon /></Toolbar.Button>
